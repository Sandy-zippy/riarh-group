    ...
    >
      <nav className="relative mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-5">
          {/* Phone kept per Dal's request, styled minimally so it doesn't crowd
              the reference's clean bar. */}
          <a
            href={`tel:${PHONE_TEL}`}
            className="hidden items-center gap-2 text-xs tracking-[0.04em] text-cream/60 transition-colors hover:text-accent xl:inline-flex"
          >
